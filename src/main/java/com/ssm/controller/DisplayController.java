...
public class DisplayController {
	...
	public @ResponseBody Object playVideoAuthor(String userid,HttpServletRequest req, HttpServletResponse resp) throws IOException {
	...
	@ResponseBody
	public Object userinfotop(HttpServletRequest req, HttpServletResponse resp)
			throws IOException {
		ObjectMapper objectMapper=new ObjectMapper();
		String json;
